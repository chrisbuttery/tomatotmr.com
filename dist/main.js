...
{
	if (region.a9.aC === region.br.aC)
	{
		return 'on line ' + region.a9.aC;
	}
	return 'on lines ' + region.a9.aC + ' through ' + region.br.aC;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ca: 'hidden', b3: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ca: 'mozHidden', b3: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ca: 'msHidden', b3: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ca: 'webkitHidden', b3: 'webkitvisibilitychange' }
		: { ca: 'hidden', b3: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bu: fragment, bw: host, bF: path, bH: port_, bK: protocol, bL: query};
	});
...
var $author$project$Main$initialModel = {O: false, aa: $author$project$Main$break, h: $author$project$Main$defaultMinutes, m: 0, k: $author$project$Main$defaultSeconds, aG: 'ding', an: false, u: 0, bc: $elm$core$Maybe$Nothing, au: $author$project$Main$pomodoro};
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		$author$project$Main$initialModel,
		$author$project$Main$emitAudioType($author$project$Main$initialModel.aG));
};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.b5) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.cg, record.b5, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	var charset = _v0.bo;
	var imports = _v0.bx;
	var namespaces = _v0.bD;
	var declarations = _v0.b6;
	var _v1 = A3(
		$elm$core$List$foldr,
	...
	return {bo: charset, b6: finalDeclarations, bx: imports, bD: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bo: charset, b6: declarations, bx: imports, bD: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bo: $elm$core$Maybe$Nothing, bx: _List_Nil, bD: _List_Nil, bQ: snippets};
};
...
var $author$project$Main$formatPageTitle = function (model) {
	...
	var mins = (((!model.k) && ((!model.m) && _Utils_eq(model.h, model.au))) || ((model.m === 1) && _Utils_eq(model.h, model.aa))) ? (model.h - 1) : model.h;
	var appName = 'TomatoTmr';
	return ((model.u === 1) || (model.u === 3)) ? ($author$project$Main$formatTime(mins) + (':' + ($author$project$Main$formatTime(secs) + (' | ' + appName)))) : appName;
};
		...
		switch (msg.$) {
			...
			case 2:
				...
				var newModel = _Utils_update(
					model,
					{h: minutes, k: $author$project$Main$defaultSeconds, u: 2});
				return _Utils_Tuple2(
					newModel,
			...
			case 0:
				...
				var mode = (!model.m) ? 1 : 0;
				var minutes = ((model.h > 0) && (model.k > 0)) ? model.h : (((model.h > 0) && (!model.k)) ? (model.h - 1) : 0);
				var commands = ((!minutes) && (!seconds)) ? (model.O ? $elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							$author$project$Main$emitPageTitle(
			...
			case 5:
				var m = msg.a;
				var commands = model.O ? $elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
...
var $rtfeldman$elm_css$Css$Transitions$durationTransition = F2(
	function (animation, duration) {
		return {aN: animation, aP: $elm$core$Maybe$Nothing, bq: duration, a_: $elm$core$Maybe$Nothing};
	});
...
var $author$project$Main$createAudioOption = F2(
	function (audio, selectedAudio) {
		var _v0 = _Utils_eq(audio, selectedAudio);
		if (_v0) {
			return A2(
...
var $rtfeldman$elm_css$Css$none = {Z: 0, bk: 0, p: 0, a: 0, f: 0, cb: 0, bz: 0, a2: 0, ak: 0, R: 0, A: 0, c: 0, b: 0, a4: 0, aV: 0, ck: 0, x: 0, aW: 0, cm: 0, ap: 0, X: 0, s: 0, e: 0, cr: 0, C: 'none'};
...
var $rtfeldman$elm_css$Css$block = {f: 0, C: 'block'};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$isBreakMode(model.m)
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						...
						A5($author$project$Main$rangeInput, $author$project$Main$BreakRange, 'Break', model.aa, 'breakRange', $author$project$Main$maxBreakRange),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								A2(
									$elm$core$List$map,
									function (o) {
										return A2($author$project$Main$createAudioOption, o, model.aG);
									},
	...
	function (key, argA, argB, argC, argD, argE, argF) {
		return A2(
			...
			A2(
				...
				' ',
				_List_fromArray(
					[argA.C, argB.C, argC.C, argD.C, argE.C, argF.C])));
	});
var $rtfeldman$elm_css$Css$boxShadow6 = $rtfeldman$elm_css$Css$prop6('box-shadow');
var $rtfeldman$elm_css$Css$inset = {p: 0, C: 'inset'};
...
var $rtfeldman$elm_css$Css$zero = {aB: 0, ai: 0, I: 0, aj: 0, ak: 0, R: 0, S: 0, aD: 0, K: 0, aV: 0, as: '', aL: 0, C: '0'};
...
var $rtfeldman$elm_css$Css$Animations$keyframes = function (tuples) {
	return $elm$core$List$isEmpty(tuples) ? {a2: 0, a4: 0, C: 'none'} : {
		a2: 0,
		a4: 0,
			...
			[
				...
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Html$Styled$Attributes$href('http://chrisbuttery.com'),
						...
						A2($author$project$Main$titleView, model.m, model.u),
						$author$project$Main$modeButtonsView(model.m),
						A2($author$project$Main$timeView, model.h, model.k),
						$author$project$Main$actionsView(model.u)
					])),
				$author$project$Main$settingsView(model.an),
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		co: $author$project$Main$subscriptions,
